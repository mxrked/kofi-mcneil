...
export const PageHead = (props) => {
  ...
  return (
    <Head>
      ...
      {/** FACEBOOK */}
      {/**
      <meta property="og:title" content={props.page_head_data.pageTitle} />
      <meta name="og:description" content={props.page_head_data.pageDesc} />
      <meta name="og:url" content={props.page_head_data.pageParent} />
      <meta name="og:image" content={props.page_head_data.ogImage} />
      <meta property="og:type" content={props.page_head_data.ogType} />
      <meta property="og:locale" content={props.page_head_data.ogLocale} />
      <meta
        name="article:author"
        content={props.page_head_data.articleAuthor}
      />
    */}
